...
import Icon2 from "../../img/upload_picture.png";
import Icon3 from "../../img/upload_audio.png";
                ...
                <U.Btns>
                    ...
                    <U.BtnSection>
                        <U.Btn2>
                            ...
                            <div className="BtnName">음성 자료</div>
                            <div className="BtnDes">폭언이 들어간 녹취 등</div>
                        </U.Btn2>
                        <U.Btn1>
                            <img className="BtnIcon" src={Icon4} alt="BtnIcon"></img>
                            <div className="BtnName">영상 자료</div>
