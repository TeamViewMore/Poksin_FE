...
function Guide() {
    const [activeBox, setActiveBox] = useState(1); // Track the active box
    const [checked, setChecked] = useState(false); // Track if checkbox should be checked
    ...
    useEffect(() => {
        const timer1 = setTimeout(() => {
            setActiveBox(2);
            setChecked(true); // Set checkbox to checked
        }, 1000); // Delay before activating Scroll2

        const timer2 = setTimeout(() => {
            setActiveBox(3);
        }, 1500); // Delay before activating Scroll3

        const timer3 = setTimeout(() => {
            setActiveBox(4);
        }, 2000); // Delay before activating Scroll4
        ...
        <G.Guide>
            <G.Section>
                <G.Scroll1>
                    <div style={{ display: "flex", flexDirection: "column" }}>
                        <G.CheckCustom
                            type="checkbox"
                            checked={checked}
                            className={checked ? "auto-check" : ""}
                            readOnly
                        />
                        <G.Line />
                    </div>
                    <G.PaperBox isActive={activeBox >= 1}>
                ...
                <G.Scroll2>
                    ...
                    <G.PhotoBox isActive={activeBox >= 2}>
                        <div style={{ height: "10px" }}></div>
                        <G.Photo>
                            &nbsp;
                            <G.Lightbulb>
                ...
                <G.Scroll3>
                    ...
                    <G.RecordBox isActive={activeBox >= 3}>
                        <div style={{ height: "10px" }}></div>
                        <G.Record>
                            &nbsp;
                            <G.Lightbulb>
                ...
                <br />
                <G.Scroll4>
                    <G.CheckCustom type="checkbox" checked={checked} className={checked ? "auto-check" : ""} readOnly />
                    <br />
                    <G.CaptureBox isActive={activeBox >= 4}>
                        <div style={{ height: "10px" }}></div>
                        <G.Capture>
                            &nbsp;
                            <G.Lightbulb>
